...

{
    ...
    "title": "Installation",
    "category": "section",
    "text": "First, install the JuAFEM.jl package by typing in the Julia REPL (console):]add https://github.com/KristofferC/JuAFEM.jl.gitThen, run the following in the Julia REPL:]add https://github.com/CoherentStructures/CoherentStructures.jl.git"
},
...

{
    ...
    "title": "Bickley Jet",
    "category": "section",
    "text": "tip: Tip\nThis example is also available as a Jupyter notebook: bickley.ipynb, and as an executable julia file bickley.jl.The Bickley jet flow is a kinematic idealized model of a meandering zonal jet flanked above and below by counterrotating vortices. It was introduced by Rypina et al.; cf. also del‐Castillo‐Negrete and Morrison.The Bickley jet is described by a time-dependent velocity field arising from a stream-function. The corresponding velocity field is provided by the package and callable as bickleyJet.Instead of using the bickleyJet function to get this velocity field, we could also use the @velo_from_stream macro:using CoherentStructures\nbickley = @velo_from_stream stream begin\n    stream = psi₀ + psi₁\n    psi₀   = - U₀ * L₀ * tanh(y / L₀)\n    psi₁   =   U₀ * L₀ * sech(y / L₀)^2 * re_sum_term\n\n    re_sum_term =  Σ₁ + Σ₂ + Σ₃\n\n    Σ₁  =  ε₁ * cos(k₁*(x - c₁*t))\n    Σ₂  =  ε₂ * cos(k₂*(x - c₂*t))\n    Σ₃  =  ε₃ * cos(k₃*(x - c₃*t))\n\n    k₁ = 2/r₀      ; k₂ = 4/r₀    ; k₃ = 6/r₀\n\n    ε₁ = 0.0075    ; ε₂ = 0.15    ; ε₃ = 0.3\n    c₂ = 0.205U₀   ; c₃ = 0.461U₀ ; c₁ = c₃ + (√5-1)*(c₂-c₃)\n\n    U₀ = 62.66e-6  ; L₀ = 1770e-3 ; r₀ = 6371e-3\nendNow, bickley is a callable function with the standard OrdinaryDiffEq signature (u, p, t) with state u, (unused) parameter p and time t."
},
...
{
    "location": "elliptic/#CoherentStructures.EllipticVortex",
    "page": "Geodesic vortices",
    "title": "CoherentStructures.EllipticVortex",
    "category": "type",
    "text": "This is a container for an elliptic vortex, as represented by the vortex\'s center and a list barriers of all computed EllipticBarriers.\n\nFields\n\ncenter: location of the vortex center;\nbarriers: vector of EllipticBarriers.\n\n\n\n\n\n"
},
...

{
    ...
    "category": "section",
    "text": "These are the specifically introduced types for elliptic LCS computations.LCSParameters\nEllipticBarrier\nEllipticVortexAnother one is Singularity, which comes along with some convenience functions.Singularity\ngetcoords\ngetindices"
},
